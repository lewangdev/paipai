...
class PaipaiPanel ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		self.m_spin_second_direct = wx.SpinCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 200000, 70000 )
		...
		self.m_spinCtrl71 = wx.SpinCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 50,-1 ), wx.SP_ARROW_KEYS, 0, 600, 57 )
		...
		self.m_spin_third_direct = wx.SpinCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.SP_ARROW_KEYS, 0, 100000, 70000 )
		...
		fgSizer152 = wx.FlexGridSizer( 1, 3, 0, 0 )
		...
		self.m_spin_option_one_pricedelta = wx.SpinCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 50,-1 ), wx.SP_ARROW_KEYS, 0, 1000, 400 )
		fgSizer152.Add( self.m_spin_option_one_pricedelta, 0, 0, 5 )
		
		self.m_staticText172111 = wx.StaticText( self, wx.ID_ANY, u"  ", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		fgSizer1521 = wx.FlexGridSizer( 1, 3, 0, 0 )
		...
		fgSizer1 = wx.FlexGridSizer( 4, 2, 10, 0 )
		...
		fgSizer1.Add( self.m_text_localtime, 0, wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_text_remotetime, 0, wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_text_countdown, 0, wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_textl_newprice, 0, wx.ALL, 5 )
		...
		self.m_staticText162 = wx.StaticText( self, wx.ID_ANY, u" ", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		bSizer5111.Add( self.m_button_start, 0, wx.ALL, 5 )
